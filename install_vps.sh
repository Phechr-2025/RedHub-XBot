...
warn "ยังไม่เริ่ม service บอทอัตโนมัติ และยังไม่ได้สั่ง enable ไว้ กรุณาตั้งค่า .env ให้เรียบร้อยก่อนแล้วค่อยเริ่มภายหลัง"

info "ติดตั้งเสร็จแล้ว"
info "โฟลเดอร์หลักของโปรเจกต์: ${ROOT_DIR}"
info "ใช้คำสั่ง ${MENU_COMMAND} เพื่อใช้งานเมนู"
info "เมื่อแก้ค่า .env เรียบร้อยแล้วค่อยสั่ง start service บอทด้วยตนเอง"
