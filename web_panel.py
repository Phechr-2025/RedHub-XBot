      ...
      <div class="wrap">
        <div class="topbar">
          ...
          <div class="topbar-copy">
            ...
            <p>UI แนวเดียวกับ 3x-ui รุ่นใหม่: เมนูซ้าย, ภาพรวม, และตั้งค่าทั่วไปในหน้าเดียว</p>
          </div>
        ...
        <section class="hero">
          ...
          <p>หน้าเว็บนี้รองรับการแก้ค่า <code>.env</code>, แสดงสถานะ service, และมีโครงสร้าง UI แบบ sidebar เพื่อให้ใช้งานใกล้เคียง 3x-ui ล่าสุดมากขึ้น</p>
        </section>
