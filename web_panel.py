    ...
    overview_cards = f"""
      <section class="card hero-card">
        <div class="hero-top">
          ...
          <div class="hero-copy">
            <div class="hero-badge">RedHub-xbot</div>
            <h1>ภาพรวมระบบแบบเรียลไทม์</h1>
            <p>สรุปสถานะเครื่องจริง CPU, RAM, Storage และ Swap ในหน้าเดียว</p>
          </div>
        </div>
    ...
    <main class="main">
      <div class="topbar">
        ...
        <div class="topbar-copy">
          ...
          <p>ภาพรวมแบบสดของ CPU, RAM, Storage และ Swap</p>
        </div>
      </div>
