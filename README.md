...
2. ดูสถานะการทำงาน — แสดงเวอร์ชั่นจากไฟล์ Release ปัจจุบัน
3. รีสตาร์ทระบบ — ยืนยัน 1 รอบ ข้อมูลในฐานข้อมูลไม่หาย
5. อัปเดตสคริประบบ — แสดงเวอร์ชั่นก่อนอัปเดตและเวอร์ชั่นล่าสุดที่ตรวจพบ จากนั้นดึง Release ล่าสุดมาใช้
...
- เปิดด้วย URL ตาม `WEB_PORT` และ path ที่สุ่มไว้ใน `WEB_PANEL_PATH`
- ถ้าเปิดแค่ `http://IP:WEB_PORT` ระบบจะพาไปยัง path ที่สุ่มไว้ให้อัตโนมัติ
