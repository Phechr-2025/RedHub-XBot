...
- เพิ่มหน้า `ฟอร์มขายสินค้า` สำหรับสร้างหมวดหมู่, สร้าง/แก้ไข/ลบสินค้า, ตั้งค่า URL ฟอร์ม, URL 3x-ui, inbound ID, รูปปก, ช่อง Discord และสั่งส่งการ์ดไปยังช่องได้ทันที
